...
pushd ${builddir}
cmake -G "Unix Makefiles" -DBUILD_ZEROMQ:BOOL=false -DBUILD_TESTING:BOOL=false -DWS_WITHOUT_TLS:BOOL=true -DCMAKE_BUILD_TYPE=Debug -Dshape_DIR:PATH=${shape} ${currentdir} 
popd
