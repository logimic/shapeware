...
def build(generator, config):
    ...
    if dirname == "shape":
        ...
        if generator == "default":
            command = "cmake" + " -DCMAKE_TOOLCHAIN_FILE=" + vcpkg + " -DLWS_WITH_SSL:BOOL=false" + " -Dshape_DIR:PATH=" + shape + " " + mainDir
        else:
            command = "cmake" + " -G \"" + generator + "\"" + " -DCMAKE_TOOLCHAIN_FILE=" + vcpkg + " -DLWS_WITH_SSL:BOOL=false" + " -Dshape_DIR:PATH=" + shape + " " + mainDir
