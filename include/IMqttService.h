...
namespace shape {
  ...
  public:
    ...
    virtual void start(const std::string& clientId) = 0;
    virtual void stop() = 0;
    ...
    virtual void sendMessage(const std::string& topic, const std::vector<uint8_t> & msg) = 0;
    virtual void sendMessage(const std::string& topic, const std::string & msg) = 0;
  };
}
