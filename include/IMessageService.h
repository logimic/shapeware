...
#ifdef IMessageService_EXPORTS
#define IMessage_DECLSPEC SHAPE_ABI_EXPORT
#else
#define IMessage_DECLSPEC SHAPE_ABI_IMPORT
#endif

namespace shape {
  class IMessage_DECLSPEC IMessageService
  {
  public:
    ...
    inline virtual ~IMessageService() {};
