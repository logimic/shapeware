...
pushd %builddir%
cmake -G "Visual Studio 15 2017 Win64" -DBUILD_ZEROMQ:BOOL=true -DBUILD_TESTING:BOOL=true -DWS_WITHOUT_TLS:BOOL=true BUILD_ZEROMQ:BOOL=true -DCMAKE_TOOLCHAIN_FILE=%vcpkg% -Dshape_DIR:PATH=%shape% %currentdir%
popd
